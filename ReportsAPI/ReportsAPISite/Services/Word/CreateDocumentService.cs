...
namespace ReportsAPISite.Services.Word
{
    public class CreateDocumentService : ICreateWordDocument
    {
        ...
        public string ReplaceDocumentStyles(CreateArgs args, string fileName)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(args.ReportStyleS3Id))
                {
                    ...
                    ReplaceDocStyles.ReplaceOtherStyles(storedS3ReportPath, generatedReportPath);
                }
        ...
        private void UpdateFontTablePart(WordprocessingDocument doc)
        {
        ...
        private void CreateTOC(string fileName, string depth)
        {
        ...
        private void SetFooterContent(WordprocessingDocument doc, string content, string position)
        {
            try
            {
        ...
        private void SetHeaderContent(WordprocessingDocument doc, string position, string image, string content)
        {
